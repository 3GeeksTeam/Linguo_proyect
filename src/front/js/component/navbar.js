	...
	const delete_account = async () => {
		try {
			...
			if (!response.ok) {
				...
				setMessage(errorData.msg || "Error al eliminar la cuenta.");
				return;
			}
			
			const data = await response.json();
			
			// Close the modal before showing the alert and navigating
			const modalElement = document.getElementById('exampleModal');
			const modalInstance = bootstrap.Modal.getInstance(modalElement);
			modalInstance.hide();
			
			// Reset the password field and message
			setPassword("");
			setMessage("");
				...
				<div className="col-12 container-fluid px-3 d-flex justify-content-between">
					...
					{isLogged ? (
						<div className="d-flex dropdown">
							<button className="user btn btn-primary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
							...
							<ul className="dropdown-menu dropdown-menu-end">
								<li>
									<button
										...
										onClick={() => {
											// Reset password and message when opening the modal
											setPassword("");
											setMessage("");
										}}
									>
				...
				<div className="modal-dialog">
					<div className="modal-content">
						...
						<div className="modal-body">
							...
							<div className="mb-3">
								<label htmlFor="passwordInput" className="form-label">Ingresa tu contraseña</label>
								<input
									id="passwordInput"
									type="password"
